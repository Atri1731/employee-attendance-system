...
// function Attendance() {
//   const [showEmployeeAnalytics, setShowEmployeeAnalytics] = useState(false);
...
function Attendance() {
  ...
  async function handleMarkAbsent() {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          data.message || "Failed to mark employee absent",
        );
      }
  ...
  async function handleUpdateStatus() {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          data.message || "Failed to update attendance status",
        );
      }
              ...
              {loading ? (
                ...
                <tr>
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-400 mt-1">
                      Attendance records will appear here when
                      employees mark their attendance.
                    </p>
              ...
              <div className="p-6 space-y-5">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={formatDate(
                      selectedCheckoutAttendance.date,
                    )}
                    disabled
                    className="w-full border border-gray-300 rounded-lg px-4 py-3 bg-gray-50 text-gray-600"
                  />
