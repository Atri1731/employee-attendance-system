...
function Attendance() {
  ...
  // Used by EmployeeAttendanceChart
  ...
  async function fetchLeaves() {
    try {
      ...
      // Keep chart working even if leaves fail
      setLeaves([]);
    }
  }

  // =========================
  // FETCH SELECTED EMPLOYEE ATTENDANCE
  // =========================

  async function handleEmployeeCalendar(employee) {
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/attendance/employee/${employee._id}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      setSelectedEmployeeAttendance(data.attendance || []);
    } catch (error) {
  ...
  async function handleUpdateCheckout() {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.message || "Failed to update checkout time");
      }
    ...
    <div className="min-h-screen bg-blue-100 p-6">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 mb-6">
        ...
        <button
          ...
          className="mt-4 px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-100 transition"
        >
          Clear Filters
        </button>
      </div>
                ...
                filteredAttendance.map((record) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm">
                      <button
                        type="button"
                        onClick={() => handleEmployeeCalendar(record.employee)}
            ...
            <div className="p-6 space-y-5">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setAbsentEmployee(e.target.value)}
                  className="w-full border border-gray-300 rounded-lg px-4 py-3 outline-none focus:ring-2 focus:ring-blue-500"
                >
